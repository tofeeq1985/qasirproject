...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" href="index.html">Local Council Athority</a>
        ...
        <div class="container">
            <div class="row block-9 justify-content-center mb-5">
                <div class="col-md-8 mb-md-5">
                    <h2 class="text-center">You have Questions ? <br>please do not hesitate to send us a message</h2>
                    <div class="alert alert-danger" role="alert">
                    </div>
                    <form method="POST" id="contact-form" class="bg-light p-5 contact-form">
                        @csrf
                    ...
                    success: function(response) {
                        ...
                        if (response.errors) {
                            ...
                            Swal.fire({
                                ...
                                text: "We got your message and we'll get back to you soon",
                                icon: "success"
                            });
